            ...
            <div>
                ...
                <?php else : ?>
                    ...
                    <select name="origine" id="origine">
                        <option value="" disabled selected>Choisissez une origine...</option>
                ...
                <?php endif; ?>
                    ...
                    <br>
                    <input type = "text" name = "nom_source" id="nom_source" placeholder="Choisissez une source... ">
